...
window.QUIZZES.su02 = [
  ...
  },
  {
    ...
    why: {
      ...
      C: { ru: "Верно. Это прямое исключение, и условия у него строгие: выплаты пожизненные и периодические, предусмотрены письменным планом, иной доли в партнёрстве нет, услуг в этом году не оказывалось. Уберите любое условие — и исключение перестанет действовать.", en: "Correct. This is an outright exclusion with strict conditions: the payments are lifelong and periodic, provided for by a written plan, there is no other interest in the partnership, and no services were performed during the year. Remove any one condition and the exclusion falls away." },
  ...
  },
  {
    ...
    why: {
      ...
      D: { ru: "Это общее правило, из которого для фермеров как раз сделано послабление: такие расходы разрешено вычитать, а не держать в базисе до продажи.", en: "That is the general rule, and farmers are the exception to it: these expenses may be deducted rather than held in basis until sale." }
    }
  },
  {
    sec: "s24",
